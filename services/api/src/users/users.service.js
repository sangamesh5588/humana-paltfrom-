...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.create = function (email, passwordPlain) {
            return __awaiter(this, void 0, void 0, function () {
                var existingUser, salt, passwordHash;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            salt = _a.sent();
                            return [4 /*yield*/, bcrypt.hash(passwordPlain, salt)];
                        case 3:
        ...
        UsersService_1.prototype.findOrCreateGoogleUser = function (email, googleId, firstName, lastName) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.findByGoogleId(googleId)];
                        case 1:
                            user = _a.sent();
                            if (user)
                                return [2 /*return*/, user];
